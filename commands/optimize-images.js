...
const MOBILE_LCP = path.join(PUBLIC_DIR, "zastrahova-patuvane.jpg");
const DESKTOP_LCP = path.join(PUBLIC_DIR, "zastrahova-patuvane.jpg");
...
async function optimizeImages() {
  ...
  try {
    ...
    console.log(`  - /zastrahova-patuvane.jpg (за мобилни устройства)`);
    console.log(`  - /zastrahova-patuvane.jpg (за десктоп устройства)`);
    console.log(
