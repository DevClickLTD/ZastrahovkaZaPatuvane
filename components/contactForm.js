...
const URL_FORM =
  "https://zastrahovkazapatuvane.admin-panels.com/wp-json/contact-form-7/v1/contact-forms/43/feedback";
    ...
    <div className="relative">
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center bg-opacity-50 z-10 pointer-events-none">
          <div className="w-12 h-12 border-4 border-gray-400 border-t-[#4E6688] rounded-full animate-spin"></div>
        </div>
      )}
      <form
      ...
      >
        <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          ...
          <div className="mt-8 flex justify-end">
            <button
              type="submit"
              className="rounded-md bg-[#4E6688] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-gray-300 cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              disabled={loading}
            >
              Изпрати запитване
            </button>
