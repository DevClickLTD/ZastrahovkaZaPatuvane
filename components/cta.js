      ...
      <div className="mx-auto max-w-10/10 py-0 sm:px-6 sm:py-0 lg:px-0">
        <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:px-16">
          <h2 className="text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl">
            Пътувайте със спокойствие
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-300">
            Започнете своето пътуване със спокойствие – изберете застраховка сега! 
            Направете запитване сега и пътувайте с увереност. Изберете между еднократни 
            и многократни полици, премиум здравни застраховки за Европа и медицински 
            застраховки за чужбина с високо покритие.
          </p>
