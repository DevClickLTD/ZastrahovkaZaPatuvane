...
export async function generateMetadata() {
  return {
    title: "Политика за поверителност - Застраховка за пътуване",
    description:
      "Научете повече за нашата политика за поверителност и как обработваме вашите лични данни при заявяване на застраховка за пътуване.",
    keywords: [
      "политика поверителност",
      "защита лични данни",
      "GDPR застраховка",
      "поверителност застрахователни данни"
    ],
    openGraph: {
      title: "Политика за поверителност - Застраховка за пътуване",
      description: "Политика за защита на личните данни при заявяване на застраховка за пътуване",
